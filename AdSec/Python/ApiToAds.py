...
from OasysUnits.Units import LengthUnit, ForceUnit
...
def api_to_ads():
    ...
    C30 = (
        Concrete.EN1992.Part1_1.Edition_2004.NationalAnnex.GB.PD6687.Edition_2010.C30_37
    )
    ...
    load_one = ILoad.Create(
        Force(float(-10), ForceUnit.Kilonewton), Moment.Zero, Moment.Zero
    )
    load_two = ILoad.Create(
        Force(float(-15), ForceUnit.Kilonewton), Moment.Zero, Moment.Zero
    )
