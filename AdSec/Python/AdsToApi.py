...
def ads_to_api():
    ...
    common_directory = Path(dirname).parents[
        1
    ]  # Third party library 'pathlib' is used to access required directory level
    ads_file_path = os.path.join(
        common_directory,
        "DocumentationOnly",
        "Python",
        "PythonCodeSnippets",
    ...
    section_one = api_sections[0]  # noqa: F841

    # Access and print warnings
    # to check for warning messages while converting JSON to API
