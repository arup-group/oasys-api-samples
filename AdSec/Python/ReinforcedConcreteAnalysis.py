...
def strength_analysis():
    ...
    sectionMaterial = (
        Concrete.EN1992.Part1_1.Edition_2004.NationalAnnex.GB.Edition_2014.C40_50
    )
    ...
    rebarMaterial = (  # noqa: E501
        Reinforcement.Steel.EN1992.Part1_1.Edition_2004.NationalAnnex.GB.Edition_2014.S500B
    )
    bar20mm = IBarBundle.Create(rebarMaterial, Length(float(20), LengthUnit.Millimeter))
    bar16mm = IBarBundle.Create(rebarMaterial, Length(float(16), LengthUnit.Millimeter))
    bar12mm = IBarBundle.Create(rebarMaterial, Length(float(12), LengthUnit.Millimeter))
